...
export const deleteCard = async (req: IAuthRequest, res: Response, next: NextFunction) => {
...
export const likeCard = async (req: IAuthRequest, res: Response, next: NextFunction) => {
  const { cardId } = req.params;
  const id = req.user;
...
export const dislikeCard = async (req: IAuthRequest, res: Response, next: NextFunction) => {
  const { cardId } = req.params;
  const id = req.user;
